...
# Loading the model.
MODEL_NAME = 'C:/Users/ASWATH/Desktop/American-Sign-Language-Recognition-using-Deep-Neural-Network-master/models/asl_alphabet_{}.h5'.format(9575)
...
while(True):
    ...
    if prediction_probability > 0.5:
        ...
        if prediction_probability >0.8:
            cv2.imwrite(img=frame,filename= 'class'+str(predicted_class)+'.jpg')
